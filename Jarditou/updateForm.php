...
?>
  ...
  <form action="script_modif.php" method="POST">
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="categorie" readonly class="form-control" id="categorie" aria-describedby="categorieProduit" value="<?php echo $row->pro_cat_id; ?>">
    </div>
    <div class="form-group">
  ...
  <div class="d-block">
    ...
    <div class="form-group mx-3">
      ...
      <input class="form-control" type="date" value="<?php echo $row->pro_d_ajout ?>" id="dateAjout" name="dateAjout">
    </div>
  </div>
