...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 27 oct. 2021 à 07:21
...
CREATE TABLE IF NOT EXISTS `users` (
  `use_id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clé de la table users',
  `use_nom` varchar(200) NOT NULL COMMENT 'Nom de utilisateur',
  `use_prenom` varchar(200) NOT NULL COMMENT 'Prenom utilisateur',
  `use_mail` varchar(200) NOT NULL COMMENT 'email utilisateur',
   `use_login` varchar(200) NOT NULL COMMENT 'pseudo utilisateur',
  `use_MDP` varchar(200) NOT NULL COMMENT 'mdp utilisateur',
   `use_date_inscription` datetime COMMENT 'inscription utilisateur',
`use_date_connexion` datetime COMMENT 'conn utilisateur',
PRIMARY KEY (`use_id`)
